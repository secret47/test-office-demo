    ...
    <div class="login">
        ...
        <div class="loginBox">
            ...
            <el-form :model="userInfo" :rules="rules" ref="loginForm" label-width="100px">
                ...
                <el-form-item>
                    <el-button type="primary" long class="logBtn" :loading="isLoading" @click="handleLogin">
                        {{ $t('login') }}
                    </el-button>
                </el-form-item>
            </el-form>
...
const rules = {
    username: [
        { required: true, message: t('usernameRull'), trigger: "blur" },
    ],
    password: [
        { required: true, message: t('passwordRull'), trigger: "blur" },
    ],
};
